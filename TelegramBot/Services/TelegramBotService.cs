    ...
    public sealed class TelegramBotService : ITelegramBotService
    {
        ...
        private async void SendFaq(Chat chat)
        {
            string infoMessage =
                ...
                "4. \"Создать игру\".\n" +
                "4.1. Эта команда позволяет начать создание игры. Последовательно будет предложено выбрать необходимые параметры: вид спорта, доступность. " +
                    ...
                    "Как найти созданную игру описано в пункте 4.2.\n" +
                "4.2. \"Мои игры\".\n" +
                ""; 
